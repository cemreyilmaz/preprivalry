...
package. You can use those functions to visualize the data in a specified trial,
run, and/or session. 

### Example
The input for the visualization functions is the same: data, session#, run#, 
tiral#. You can visualize the data for a run or a trial. Althought you do not

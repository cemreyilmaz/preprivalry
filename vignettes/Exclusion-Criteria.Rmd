...
library(preprivalry)
```
If the participants have a strong eye dominance or they responded ver unreliably, their data are misleading for our purposes. Therefore, we exclude such cases. 

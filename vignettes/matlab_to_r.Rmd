...
data <- preprivalry::read_rivdata(directory,"Gratings","s001",s)

```
data is a list containing all the info about the experiment such that:
...
data
 ...
 --whichExperiment
 ```
Our interest will be on data[["list"]] for the further steps.
